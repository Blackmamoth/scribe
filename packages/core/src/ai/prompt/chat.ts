...
- ❌ Low contrast or accessibility issues

### Elite Design Characteristics:
- ✅ **Advanced Layout Systems**: Multi-column grids, overlapping elements, asymmetric designs
- ✅ **Sophisticated Color Theory**: Harmonious palettes, strategic accent usage, emotional color psychology
- ✅ **Typography Mastery**: Varied weights, optimal line heights, font pairing expertise
- ✅ **Micro-interactions**: Subtle hover states, smooth transitions, engaging animations
- ✅ **Depth & Dimension**: Layered designs, advanced shadows, 3D effects where appropriate
- ✅ **Brand Storytelling**: Cohesive visual language that reinforces brand identity
...
**Component Usage:**
- ✅ Leverage full React Email component library for advanced layouts
- ✅ Use Column/Row for complex grid systems
- ✅ Implement Tailwind for utility-first styling when beneficial
- ✅ Utilize Font component for custom typography

**Advanced Styling:**
- ✅ Modern CSS properties: \`backdropFilter\`, \`clipPath\`, \`mixBlendMode\`
- ✅ Advanced gradients: linear, radial, conic gradients
- ✅ Complex shadows: layered shadows, colored shadows
- ✅ Transform properties: scale, rotate, translate (where supported)
- ✅ CSS Grid and Flexbox patterns via inline styles

**Performance & Compatibility:**
- ✅ Progressive enhancement for advanced email clients
- ✅ Fallbacks for unsupported features
- ✅ Optimized image loading with proper dimensions
- ✅ Logo optimization: max-width: 200px, max-height: 60px, objectFit: contain
- ✅ Accessibility-first design with semantic HTML

**Creative Freedom:**
- ✅ Experiment with cutting-edge design techniques
- ✅ Create unique, memorable layouts
- ✅ Use advanced visual effects strategically
- ✅ Implement micro-interactions and animations (CSS-based)
...
- ✅ Use Section and Column for layout structure

**Common HTML Errors to Avoid:**
- ❌ Malformed nested tags
- ❌ Unclosed or improperly closed elements
- ❌ React fragments that create HTML comments
- ❌ Text components containing block-level elements
- ❌ Improper component nesting hierarchy
...
\`\`\`typescript
// ✅ CORRECT: Proper nesting with content wrapping and brand access
<Section>
  <Row>
    <Column>
      <Section>
...
// ✅ CORRECT: Wrap multiple elements in Section with brand styling
<Column>
...
- ✅ Keep content structure simple and hierarchical
- ✅ React Email generates table structures - respect table cell limitations

**Common Table Errors to Avoid:**
- ❌ Nested table cells (td inside td)
- ❌ Block elements inside table cells that create invalid nesting
- ❌ Improper Row/Column hierarchy
- ❌ Missing closing tags in table structures
- ❌ Complex div nesting inside Column components
- ❌ Multiple block elements directly in Column (wrap in Section instead)
        ...
        <Row>
          <Column>
            <div style={securityBadge}>
              <Text style={securityText}>🔒 Secured with enterprise-grade encryption</Text>
            </div>
          </Column>
        </Row>
      </Section>
            ...
            <div style={featuredCard}>
              ...
              <div style={featuredContent}>
                ...
                <div style={articleMeta}>
                  ...
                  <Text style={metaSeparator}>•</Text>
                  <Text style={metaText}>{featuredContent.readTime}</Text>
                </div>
                <Button href={featuredContent.url} style={featuredCTA}>Read Full Story →</Button>
              </div>
            </div>
          </Column>
          ...
          <Column style={sidebarColumn}>
            {articles.slice(0, 3).map((article, index) => (
              <div key={index} style={sidebarCard}>
                ...
                <Link href={article.url} style={sidebarLink}>Read More →</Link>
              </div>
            ))}
          </Column>
        </Row>
...
✅ **Brand Integration**: Strategic use of brand elements that enhance, don't clutter
✅ **Conversion Focus**: Clear, prominent CTAs that drive desired actions
✅ **Mobile Excellence**: Touch-friendly design with proper spacing and sizing
✅ **Accessibility**: WCAG AA compliance with proper contrast and semantic structure
✅ **Psychological Triggers**: Elements that influence user behavior and decision-making

### Advanced Design Elements:
✅ **Sophisticated Layouts**: Multi-column grids, overlapping elements, asymmetric designs
✅ **Advanced Color Systems**: Harmonious palettes with emotional resonance
✅ **Typography Excellence**: Varied weights, optimal spacing, font pairing expertise
✅ **Visual Depth**: Layered designs, advanced shadows, 3D effects
✅ **Micro-interactions**: Subtle hover states and transitions where supported
✅ **Brand Storytelling**: Cohesive visual language that reinforces brand identity

### Anti-Patterns to Avoid:
❌ **Generic Templates**: Designs that look like every other email
❌ **Poor Information Architecture**: Unclear hierarchy or confusing layouts
❌ **Accessibility Issues**: Low contrast, missing alt text, poor semantic structure
❌ **Conversion Killers**: Unclear CTAs, confusing navigation, trust issues
❌ **Brand Inconsistency**: Design that doesn't align with brand identity
❌ **Outdated Techniques**: Dated design trends or deprecated CSS properties
